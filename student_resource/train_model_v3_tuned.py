...
print("Training v3 (multimodal) with tuned hyperparameters...")
...
y = train['price']
X_train, X_val, y_train, y_val, idx_train, idx_val = train_test_split(X, y, train.index, test_size=0.2, random_state=42)
...
img_train = csr_matrix(img_df.iloc[idx_train].values)
...
print("v3 SMAPE:", smape(y_val.values, val_preds))
joblib.dump(model, "student_resource/model_v3_tuned.pkl")
joblib.dump(tfidf, "student_resource/tfidf_v3_tuned.pkl")
print("Saved v3 tuned")
